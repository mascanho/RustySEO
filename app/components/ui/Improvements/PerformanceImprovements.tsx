...
const PerformanceImprovements = ({ pageSpeed }: any) => {
  ...
  return (
    <section className="bg-gray-300 w-full dark:bg-brand-darker py-6 px-1 pl-4 rounded-lg shadow max-w-7xl mx-auto mt-1.5 text-xs">
      ...
      <div className="space-y-3 overflow-auto custom-scrollbar h-[calc(100vh-18.4rem)] pl-2 py-2 pr-3 bg-trasnparent rounded-md dark:bg-brand-darker rounded-lg">
