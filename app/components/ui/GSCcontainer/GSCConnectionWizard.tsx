        ...
        try {
            ...
            const unlisten = await (await import("@tauri-apps/api/event")).listen<string>("gsc-auth-code", async (event) => {
                ...
                try {
                    ...
                    const token = await invoke<string>("exchange_gsc_code", {
                        code,
            ...
            const authUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${config.clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=https://www.googleapis.com/auth/webmasters.readonly&prompt=select_account`;
