...
export default function SearchConsoleConfs() {
    ...
    return (
      <Card className="w-full p-8 flex flex-col items-center justify-center shadow-none border-0 bg-transparent">
        <div className="p-4 bg-gray-50 dark:bg-white/[0.03] rounded-2xl border border-dashed border-gray-200 dark:border-white/10 text-center max-w-sm">
          ...
          >
            Go to <b>Menu &gt; Connectors &gt; Search Console</b> to authorize
            your Google account and select a property.
          </Text>
        </div>
      </Card>
    );
  ...
  return (
    <Card className="w-full shadow-none  mx-auto dark:bg-transparent  border-0 pb-10">
        ...
        <div className="flex items-start space-x-4 p-4 rounded-xl bg-brand-bright/10 dark:bg-brand-bright/5 border border-brand-bright/20 dark:border-brand-bright/10">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-brand-bright uppercase tracking-wider mb-1"
            >
              Project ID
            </Text>
            <Text
        ...
        <div className="flex items-start space-x-4 p-4 rounded-xl bg-green-50/30 dark:bg-green-500/5 border border-green-100/50 dark:border-green-500/10">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-green-600 dark:text-green-400 uppercase tracking-wider mb-1"
            >
              Client ID
            </Text>
            <Text
              size="sm"
              className="text-gray-600 dark:text-gray-400 break-all font-mono text-[11px] leading-tight mt-1"
            >
              {confs?.client_id}
            </Text>
          </div>
          ...
          <div className="w-full">
            <Group justify="space-between" align="center" mb={4}>
              <Text
                fw={800}
                size="xs"
                className="text-purple-600 dark:text-purple-400 uppercase tracking-wider"
              >
                Client Secret
              </Text>
              <Button
            ...
            <Text
              size="sm"
              className="text-gray-600 dark:text-gray-400 font-mono tracking-tighter"
            >
              {showSecret
                ? confs?.client_secret
                : "••••••••••••••••••••••••••••••••••••••••"}
        ...
        <div className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-red-500 dark:text-red-400 uppercase tracking-wider mb-1"
            >
              Property URL
            </Text>
            <Text
        ...
        <div className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-orange-500 dark:text-orange-400 uppercase tracking-wider mb-1"
            >
              Search Type
            </Text>
            <Text
              size="sm"
              className="text-gray-700 dark:text-gray-300 font-medium italic capitalize"
            >
              {confs?.search_type}
            </Text>
          </div>
        ...
        {/*<div className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-teal-600 dark:text-teal-400 uppercase tracking-wider mb-1"
            >
              Default Range
            </Text>
            <Text
        ...
        {/*<div className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/5 ">
          ...
          <div>
            <Text
              fw={800}
              size="xs"
              className="text-indigo-600 dark:text-indigo-400 uppercase tracking-wider mb-1"
            >
              Row Limit
            </Text>
            <Text
