...
export default function GA4ConnectionWizard({ onComplete, onClose }: GA4ConnectionWizardProps) {
    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            const unlisten = await (await import("@tauri-apps/api/event")).listen<string>("gsc-auth-code", async (event) => {
                ...
                <AnimatePresence mode="wait" custom={step}>
                        ...
                        >
                            <div className="flex-1 flex flex-col items-center justify-center space-y-4">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-lg font-bold dark:text-white">Analyze User Behavior</h3>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs mx-auto">
                                        Connect Google Analytics 4 to track sessions, bounce rates, and user engagement.
                                    </p>
                                </div>
                            ...
                            <div className="pt-4">
                                <Button onClick={handleNext} className="w-full bg-orange-600 hover:bg-orange-700 text-white py-5 rounded-xl group text-sm">
                                    Get Started
                    ...
                    {step === 2 && (
                        ...
                        >
                            <div className="flex-1 space-y-4">
                                <div className="space-y-1">
                                    <h3 className="text-md font-bold dark:text-white">API Configuration</h3>
                                ...
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        <label className="text-[9px] font-bold uppercase tracking-wider text-gray-400">Client ID</label>
                                        <Input
                                            value={config.clientId}
                                            onChange={(e) => setConfig({ ...config, clientId: e.target.value })}
                                            placeholder="xxx-xxx.apps.googleusercontent.com"
                                            className="bg-gray-50 dark:bg-brand-dark border-gray-200 dark:border-brand-dark h-9 text-xs"
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-[9px] font-bold uppercase tracking-wider text-gray-400">Project ID</label>
                                        <Input
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[9px] font-bold uppercase tracking-wider text-gray-400">Client Secret</label>
                                        <Input
                                            type="password"
                            ...
                            <div className="flex gap-3 pt-4">
                                <Button variant="ghost" onClick={handleBack} className="flex-1 py-5 rounded-xl text-xs">Back</Button>
                                <Button onClick={handleNext} className="flex-[2] bg-orange-600 hover:bg-orange-700 text-white py-5 rounded-xl text-xs">
                                    Continue
                                </Button>
                            </div>
                        </motion.div>
                    ...
                    {step === 3 && (
                        ...
                        >
                            <div className="flex-1 flex flex-col items-center justify-center space-y-6">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-lg font-bold dark:text-white">Authorize GA4 Access</h3>
                    ...
                    {step === 4 && (
                        ...
                        >
                            <div className="flex-1 space-y-4">
                                <div className="space-y-1">
                                    <h3 className="text-md font-bold dark:text-white">Select GA4 Property</h3>
                                    <p className="text-[10px] text-gray-500 dark:text-gray-400">
                                ...
                                <div className="max-h-[220px] overflow-y-auto space-y-1.5 pr-1 custom-scrollbar">
                                    {properties.map((prop) => (
                                        <button
                                            ...
                                            className={`w-full p-3 rounded-lg border text-left transition-all flex items-center justify-between ${selectedProperty?.property === prop.property
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <BarChart3 className={`h-3.5 w-3.5 ${selectedProperty?.property === prop.property ? "text-orange-600" : "text-gray-400"}`} />
                                            ...
                                            {selectedProperty?.property === prop.property && <CheckCircle2 className="h-3.5 w-3.5 text-orange-600" />}
                                        </button>
                                    ))}
                                </div>
                            </div>
