  ...
  return (
    ...
    >
      ...
      {viewDetails && Object.keys(openGraphDetails).length > 0 ? (
        <div className="h-full w-full px-4 py-2 flex flex-col justify-start items-start space-y-2 overflow-hidden rounded-lg">
          ...
          <div className="flex flex-col w-full bg-white dark:bg-gray-800 p-2 rounded-md">
            ...
            <span className="text-xs text-apple-spaceGray/70 dark:text-white/50 break-all">
          ...
          <div className="flex flex-col w-full bg-white dark:bg-gray-800 p-2 rounded-md">
            ...
            <span className="text-xs text-apple-spaceGray/70 break-all dark:text-white/50">
