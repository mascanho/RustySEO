...
function MissingTitlesChart() {
  ...
  const missingTitles = issuesData?.missingTitles || 0;

  const chartData = [
    // { browser: "HTML", visitors: totalPages, fill: "hsl(210, 100%, 50%)" },
    {
      browser: "Duplicated",
      visitors: missingTitles || 0,
      fill: "hsl(710, 100%, 60%)",
    },
    {
      browser: "Normal",
      visitors: totalPages - missingTitles || 0,
      fill: "hsl(210, 100%, 70%)",
    },
  ];
    ...
    <Card className="flex flex-col dark:bg-gray-900 bg-slate-100 border-0 shadow-none">
      ...
      <CardFooter className="flex-col gap-2 text-xs dark:text-white/50">
        <div className="leading-none text-muted-foreground">
          RustySEO found{" "}
          <span className="text-red-500">{missingTitles || 0}</span> Missing
          Page Titles
        </div>
...
export default MissingTitlesChart;
