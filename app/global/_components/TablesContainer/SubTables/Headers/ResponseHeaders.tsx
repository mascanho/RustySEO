    ...
    <div>
      <div className="px-0">
        ...
        <div className="bg-white dark:bg-brand-darker dark:text-white rounded pb-3">
          <h3 className="m-0 text-xs font-semibold text-xs pl-4 dark:text-white/50 mb-1">
            Response Headers
          </h3>
          <div>
            {headers.map((header, index) => (
              <div
                key={index}
                className="grid grid-cols-[300px_1fr] gap-2 px-4  border-b border-gray-200 last:border-b-0 dark:border-white/30 text-xs flex items-center"
              >
