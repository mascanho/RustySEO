...
export default function DashboardSEO() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<
    "overview" | "trends" | "comparison" | "issues" | "duplicates"
  >("overview");
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-6 border-b border-slate-200 dark:border-slate-800/60 pb-px">
            {[
              ...
              { id: "duplicates", label: "Duplicate Content" },
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 max-w-lg">
                    Clusters pages that share identical headings or
                    near-identical body content, using fingerprints captured
                    during the crawl. Runs on demand — nothing is computed
                    automatically.
                  </p>
                </div>
                <button
              ...
              {!duplicateReport ? (
                ...
                <div className="py-14 flex flex-col items-center gap-3 text-center">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 max-w-sm">
                    This is an opt-in check since fingerprinting adds
                    per-page processing time. Enable{" "}
                ...
                <div className="py-14 flex flex-col items-center gap-2 text-center">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 max-w-sm">
                    If this crawl predates enabling the check, pages won't
                    have a fingerprint yet — re-run the crawl and analyze
                    again.
                  </p>
                </div>
              ) : (
