...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-7  items-center space-x-1  border-slate-200 bg-gray-200  dark:border-slate-800 ",
      className,
    )}
    {...props}
  />
