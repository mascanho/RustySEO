...
interface OnPageSeoState {
  ...
  setSeoUrlLength: (seoUrlLength: number | null) => void;
}
...
const useOnPageSeo = create<OnPageSeoState>((set) => ({
  ...
  setSeoRenderBlocking: (seoRenderBlocking) => set({ seoRenderBlocking }),
  setSeoContentQuality: (seoContentQuality) => set({ seoContentQuality }),
  setSeoMedia: (seoMedia) => set({ seoMedia }),
  setSeoUrlLength: (seoUrlLength) => set({ seoUrlLength }),
}));
